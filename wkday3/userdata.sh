...
CHEF_SERVER_NAME="MyAutomateServer" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="myautomateserver-yj7c1ihywpqa6dqo.us-west-2.opsworks-cm.io" # The FQDN of your Chef Server
...
RUN_LIST="recipe[chef-client],recipe[simple_webapp]"
